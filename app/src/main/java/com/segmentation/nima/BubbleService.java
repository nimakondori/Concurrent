...
public class BubbleService extends Service
    ...
    private int[] ClipRegioBubble = new int[4];
    //====================================================================================== QUS  Variables ===================================================================================
    // ---------------------------------- Network Constants ----------------------------------------
    ...
    public void finishClipMode(int[] clipRegion) {
        ...
        if (clipRegion[2] < 50 || clipRegion[3] < 50) {
            ...
            if (mScreenSheetBindingParams == null) {
                mScreenSheetBindingParams = buildLayoutParamsForSheet(0,0, clipRegion);
                    ...
                    new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader reader) {
                            try {
                                ...
                                resizedOutputBitmap = Bitmap.createBitmap(128, 128, Bitmap.Config.ARGB_8888);
